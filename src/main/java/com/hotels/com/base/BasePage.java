...
public class BasePage {
	...
	public Properties initialize_properties(){
		...
		try {
			FileInputStream ip = new FileInputStream("/Users/sevimbalci/Documents/workspace/Hotel.com3"
					+ "/src/main/java/config/hotels/com/config/config.properties");
			prop.load(ip);
		} catch (IOException e) {
			e.printStackTrace();
		}
